...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(options.maxEvents),# remember to set this
    output = cms.optional.untracked.allowed(cms.int32,cms.PSet)
)

# Input source
process.source = cms.Source("PoolSource",
#    fileNames = cms.untracked.vstring('file:'+options.inputFile), # update this
...
process.options = cms.untracked.PSet(
    ...
    numberOfThreads = cms.untracked.uint32(8), # 8? up to 24
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string("file:{}".format(options.__getattr__("outputFile", noTags=True))),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:'+options.outputFileDQM),
...
process.validation_step11 = cms.EndPath(process.validationMiniAOD)
